# TaiseChat Localization Guide

This guide explains how to add new languages to TaiseChat's localization system.

## Adding a New Language

To add a new language to TaiseChat, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the upstream [locize project](https://www.locize.app/cat/62uyy7c9),
...
1. The empty translation file can be populated through the upstream translation platform
